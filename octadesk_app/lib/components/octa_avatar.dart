...
class OctaAvatar extends StatelessWidget {
  ...
  const OctaAvatar({
    ...
    this.fontColor = AppColors.gray700,
  ...
  Widget _renderImage() {
    return Container(
      ...
      decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(borderRadius)), color: AppColors.gray100),
  ...
  Widget _renderInitials() {
    return Container(
      decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(borderRadius)), color: backgroundColor),
      child: Center(
        child: Text(
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border: showBorder ? Border.all(color: AppColors.gray800, width: 2) : null,
          ),
